...
describe("context pressure assessment", () => {
	it("summarizes bounded injection, compaction, and provider/cache facts", () => {
		const result = assessContextTelemetry(
			[
				row(1, "papyrus-context", "injected-characters", 100, "count", 1_000, {
					ruleCharacters: 60,
					taskCharacters: 40,
					estimatedTokens: 25,
					share: 0.1,
				...
				row(2, "papyrus-context", "injected-characters", 300, "count", 2_000, {
					ruleCharacters: 100,
					taskCharacters: 200,
					estimatedTokens: 75,
					share: 0.3,
			...
			[
				row(3, "pi-context", "compaction-duration", 500, "milliseconds", 3_000, {
					reason: "threshold",
					turnsSincePrevious: 4,
					elapsedSincePreviousMs: 2_000,
					providerTokensSincePrevious: 2_500,
					cacheReadTokensSincePrevious: 1_000,
				}),
				row(4, "pi-context", "compaction-duration", 1_500, "milliseconds", 5_000, {
					reason: "overflow",
					turnsSincePrevious: 2,
					elapsedSincePreviousMs: 2_000,
					providerTokensSincePrevious: 1_500,
					cacheReadTokensSincePrevious: 500,
					willRetry: true,
				}),
